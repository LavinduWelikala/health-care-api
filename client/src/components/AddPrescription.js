...
function AddPrescription({ closeModal, details }) {
  const id = details;
  ...
  function generatePrescription(event) {
    ...
    function generateLink() {
      const doc = new jsPDF("portrait", "px", [200, 300], "false");
      ...
      doc.setFontSize(12);
      doc.text(10, 40, "Prescription ID: " + id);
      doc.text(10, 55, "Generated By Dr. " + name);

      // Format medicine details into table
      const tableHeaders = ["Medicine"];
      const tableData = medicine.map((med) => {
        const [medicine, dosage] = med.split(", ");
